...
\cvachievement{\faTrophy}{\color{alphabetg}G\color{alphabeto}o\color{alphabeto}o\color{alphabetg}g\color{alphabetl}l\color{alphabete}e\hspace{0.3em}\color{emphasis} Travel Grants}{An all expenses paid opportunity to attend the Grace Hopper Conference India 2016. }
